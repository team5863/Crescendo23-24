...
public class TwoNoteLeaveRed extends SequentialCommandGroup{

    public TwoNoteLeaveRed(DriveTrain m_driveTrain, Shooter m_shooter, Serializer m_serializer, LED m_LEDcontrol, Intaker m_intake){
